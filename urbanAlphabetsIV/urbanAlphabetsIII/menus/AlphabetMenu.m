...
- (id)initWithFrame:(CGRect)frame text:(NSString*)titleText lastView:(NSString*)lastView
{
    ...
    if (self) {
        ...
        self.saveAlphabetIcon=[C4Image imageNamed:@"icon_Save"];
        ...
        self.shareAlphabetIcon=[C4Image imageNamed:@"icon_ShareAlphabet"];
        ...
        self.alphabetInfoIcon=[C4Image imageNamed:@"icon_information"];
