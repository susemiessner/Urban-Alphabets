...
-(void)setupWithLanguage: (NSString*)passedLanguage Alphabet:(NSMutableArray*)passedAlphabet{
    ...
    self.topNavBar = [[TopNavBar alloc] initWithFrame:topBarFrame text:@"Write postcard" lastView:@"AlphabetView"];
...
-(void)removeFromView{
    ...
    [textViewTest removeFromSuperview];
...
- (void)textViewDidEndEditing:(UITextView *)textView
{
    ...
    [self removeFromView];
    [self postNotification:@"goToPostcardView"];
}
