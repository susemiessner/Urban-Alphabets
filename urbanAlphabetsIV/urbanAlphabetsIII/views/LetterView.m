...
-(void)setupWithLetterNo: (int)chosenNumber currentAlphabet:(NSMutableArray*)passedAlphabet{
    ...
    self.bottomNavBar = [[BottomNavBar alloc] initWithFrame:bottomBarFrame leftIcon:[C4Image imageNamed:@"icon_ArrowBack"] withFrame:CGRectMake(0, 0, 70, 35) centerIcon:[C4Image imageNamed:@"icon_Alphabet"] withFrame:CGRectMake(0, 0, 80, 45) rightIcon:[C4Image imageNamed:@"icon_ArrowForward"] withFrame:CGRectMake(0, 0, 70, 35)];
