...
void testApp::updateAlphabet(){
    ...
    if (currentURL==currentAlphabet && currImgNo2>39 && allAlphabet[currImgNo2]._xPos<-221) {
        goToNextScreen();
        counterDrawAlphabet=0;
    }
}
...
void testApp::drawPostcards(){
    ...
    //draw title
    postcardsTitle.draw(ofGetWidth()-postcardsTitle.width, ofGetHeight()-70-barHeight);
    //draw postcards
    if (noOfPostcards>0) {
...
void testApp::drawLetters(){
    ...
    //draw title
    lettersTitle.draw(ofGetWidth()-lettersTitle.width, ofGetHeight()-70-barHeight);
    //draw letters
    if(noOfLetters>0){
...
void testApp::drawAlphabet(){
    ...
    alphabetTitle.draw(ofGetWidth()-alphabetTitle.width, ofGetHeight()-70-barHeight);
    ...
    if(counterDrawAlphabet>FRAME_RATE*alphabetLength){
        ...
        //blend out
        else if(currentURL==currentAlphabet && currImgNo2>39 && allAlphabet[currImgNo2]._xPos<-221){
            blendInfo-=8;
            ofSetColor(255, 255, 255, blendInfo);
        } else{
            ofSetColor(255);
