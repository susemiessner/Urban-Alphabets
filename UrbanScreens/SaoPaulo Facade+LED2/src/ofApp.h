...
class ofApp : public ofBaseApp{
    ...
    int blendInfoLED2; //same for the LED
    ...
    int currImgNoAlphabetLED2[NO_OF_ALPHABETS_RUNNING_THROUGH];
    ...
    ofImage alphabetTitleFacade, alphabetTitleLED2, lettersTitleFacade, lettersTitleLED2, postcardsTitleFacade, postcardsTitleLED2;
