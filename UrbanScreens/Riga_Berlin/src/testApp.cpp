...
void testApp::draw(){
    ...
    if(loading==false){
        ...
        if(currentURL!=info){
            ...
            ofRect(AROUND, questionsLat[0].height+questions[0].height+AROUND, (ofGetWidth()-AROUND*4)/2, ofGetHeight()-questionsLat[0].height-questions[0].height-AROUND*2);
            //background for Riga
            ofRect(AROUND*3+(ofGetWidth()-AROUND*4)/2, questionsLat[0].height+questions[0].height+AROUND, (ofGetWidth()-AROUND*4)/2, ofGetHeight()-questionsLat[0].height-questions[0].height-AROUND*2);
            ofSetColor(255);
            ofEnableAlphaBlending();
            riga.draw(AROUND, questionsLat[0].height +questions[0].height+AROUND*2);
            berlin.draw(ofGetWidth()-berlin.width-AROUND, questionsLat[0].height+questions[0].height+AROUND*2);
...
void testApp::drawPostcards(){
    ...
    //draw title
    ofSetColor(255);
    questionsLat[currentQuestionNumber].draw(0,0);
    questions[currentQuestionNumber].draw(AROUND,questionsLat[currentQuestionNumber].height);

    postcardsTitleLat.draw((ofGetWidth()-postcardsTitleLat.width-AROUND), 0);
    postcardsTitle.draw((ofGetWidth()-postcardsTitle.width-AROUND), postcardsTitleLat.height);
    ofDisableAlphaBlending();
}
void testApp::drawLetters(){
    ...
    //draw title
    ofSetColor(255);
    lettersTitleLat.draw((ofGetWidth()-lettersTitleLat.width-AROUND), 0);
    lettersTitle.draw((ofGetWidth()-lettersTitle.width-AROUND), lettersTitleLat.height);
    ofDisableAlphaBlending();
}
void testApp::drawAlphabet(){
    ...
    ofSetColor(255);
    alphabetTitleLat.draw((ofGetWidth()-alphabetTitleLat.width-AROUND), 0);
    alphabetTitle.draw((ofGetWidth()-alphabetTitle.width-AROUND), alphabetTitleLat.height);
    ofDisableAlphaBlending();
}
