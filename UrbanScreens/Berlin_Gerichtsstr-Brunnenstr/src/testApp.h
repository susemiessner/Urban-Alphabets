...
public:
    ...
    string info;
    string recentPostcardsGerichtsstrasse;
    string recentLettersGerichtsstrasse;
    string currentAlphabetGerichtsstrasse;
    string recentPostcardsBrunnenstrasse;
    string recentLettersBrunnenstrasse;
    string currentAlphabetBrunnenstrasse;
    string currentQuestion;
    
    //Berlin and Riga images
    ofImage gerichsstrasse;
    ofImage brunnenstrasse;
    ...
    vector<Postcard> allPostcardsGerichtsstrasse; //all postcards from Gerichtsstrasse
    vector<Postcard> allPostcardsBrunnenstrasse; //all postcards from Brunnenstrasse
    vector<Letter> allLettersGerichtsstrasse; //all recent letters from Gerichtsstrasse
    vector<Letter> allLettersBrunnenstrasse; //all recent letters from Brunnenstrasse
    ...
    vector<AlphabetEntry> allAlphabetGerichtsstrasse; //the entire alphabet from Gerichtsstrasse
    vector<AlphabetEntry> newAlphabet;
    vector<AlphabetEntry> allAlphabetBrunnenstrasse; //the entire alphabet from Brunnenstrasse
