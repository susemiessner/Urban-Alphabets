...
-(void)setup {
    //load the defaults
    self.currentLanguage= @"Danish/Norwegian";
    self.userName=@"MAB";
...
-(void)loadAlphabetFromServer{
    ...
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] initWithURL:[NSURL    URLWithString:@"http://www.ualphabets.com/requests/Aarhus/alphabet.php"]];
