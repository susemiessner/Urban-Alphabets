...
#define UA_IPAD_LETTER_IMG_HEIGHT_5 102.0f
#define UA_IPAD_LETTER_IMG_WIDTH_5 86.0f

#define UA_LETTER_IMG_HEIGHT_4 52.55f
#define UA_LETTER_IMG_WIDTH_4 43.019f
#define UA_IPAD_LETTER_SIDE_MARGIN_ALPHABETS 126.00f
...
#define UA_ICON_SETTINGS        [UIImage imageNamed:@"icon_Settings"]
#define UA_ICON_INFO            [UIImage imageNamed:@"icon_information"]
#define UA_ICON_SHARE_ALPHABET  [UIImage imageNamed:@"icon_ShareAlphabet"]
