...
-(void)setupPad{
    ...
    self.cancelShape=[[UIView alloc]initWithFrame:CGRectMake(sideMargin, self.frame.size.height-(sideMargin+height), self.frame.size.width-2*sideMargin, height)];
    ...
    //shape
    self.settingsShape=[[UIView alloc] initWithFrame:CGRectMake(self.self.frame.size.width-width-sideMarginIpad, self.frame.size.height-((sideMargin+height)*2), width-smallMargin, height)];
    ...
    //image
    self.settingsIcon=[[UIImageView alloc]initWithFrame:CGRectMake(self.settingsShape.frame.origin.x+20, self.settingsShape.frame.origin.y+10, 70, 70)];
    ...
    //shape
    self.myAlphabetsShape=[[UIView alloc] initWithFrame:CGRectMake(self.self.frame.size.width-width*2-sideMarginIpad, self.frame.size.height-((sideMargin+height)*2), width-smallMargin, height)];
    [self.myAlphabetsShape setBackgroundColor:UA_WHITE_COLOR];
    [self addSubview:self.myAlphabetsShape];
    
    //label
    self.myAlphabetsLabel=[[UILabel alloc]initWithFrame:CGRectMake(self.myAlphabetsShape.frame.origin.x, self.myAlphabetsShape.frame.origin.y+40, self.myAlphabetsShape.frame.size.width, self.myAlphabetsShape.frame.size.height)];
    ...
    self.writePostcardShape=[[UIView alloc]initWithFrame:CGRectMake(self.self.frame.size.width-width*3-sideMarginIpad, self.frame.size.height-((sideMargin+height)*2), width-smallMargin, height)];
    [self.writePostcardShape setBackgroundColor:UA_WHITE_COLOR];
    [self addSubview:self.writePostcardShape];
    
    self.writePostcardLabel=[[UILabel alloc]initWithFrame:CGRectMake(self.writePostcardShape.frame.origin.x, self.writePostcardShape.frame.origin.y+40, self.writePostcardShape.frame.size.width, self.writePostcardShape.frame.size.height) ];
    ...
    self.saveAlphabetShape=[[UIView alloc]initWithFrame:CGRectMake(self.self.frame.size.width-width*4-sideMarginIpad, self.frame.size.height-((sideMargin+height)*2), width-smallMargin, height)];
    [self.saveAlphabetShape setBackgroundColor:UA_WHITE_COLOR];
    [self addSubview:self.saveAlphabetShape];
    
    self.saveAlphabetLabel=[[UILabel alloc]initWithFrame:CGRectMake(self.saveAlphabetShape.frame.origin.x, self.saveAlphabetShape.frame.origin.y+40, self.saveAlphabetShape.frame.size.width, self.saveAlphabetShape.frame.size.height)];
    ...
    self.shareAlphabetShape=[[UIView alloc]initWithFrame:CGRectMake(self.self.frame.size.width-width*5-sideMarginIpad, self.frame.size.height-((sideMargin+height)*2), width-smallMargin, height)];
    [self.shareAlphabetShape setBackgroundColor:UA_WHITE_COLOR];
    [self addSubview:self.shareAlphabetShape];
    
    self.shareAlphabetLabel=[[UILabel alloc]initWithFrame:CGRectMake(self.shareAlphabetShape.frame.origin.x, self.shareAlphabetShape.frame.origin.y+40, self.shareAlphabetShape.frame.size.width, self.shareAlphabetShape.frame.size.height)];
    ...
    self.alphabetInfoShape=[[UIView alloc] initWithFrame:CGRectMake(self.self.frame.size.width-width*6-sideMarginIpad, self.frame.size.height-((sideMargin+height)*2), width-smallMargin, height)];
    [self.alphabetInfoShape setBackgroundColor:UA_WHITE_COLOR];
    [self addSubview:self.alphabetInfoShape];
    
    self.alphabetInfoLabel=[[UILabel alloc]initWithFrame:CGRectMake(self.alphabetInfoShape.frame.origin.x, self.alphabetInfoShape.frame.origin.y+40, self.alphabetInfoShape.frame.size.width, self.alphabetInfoShape.frame.size.height)];
