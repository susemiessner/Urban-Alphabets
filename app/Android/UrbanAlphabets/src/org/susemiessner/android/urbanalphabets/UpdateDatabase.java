...
public class UpdateDatabase extends AsyncTask<Void, Void, Void> {
  ...
  public UpdateDatabase(Context context, String longitude, String latitude, String userName,
      String letter, String postcard, String alphabet, Bitmap bitmap, String language,
      String postcardText) {
    super();
